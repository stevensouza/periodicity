...
![Example1](https://github.com/stevensouza/periodicity/blob/master/visualizations/24hourmod_calendar1.png)

Other 'run' commands generated the following images.

![Example2](https://github.com/stevensouza/periodicity/blob/master/visualizations/periodicity1.png)
![Example3](https://github.com/stevensouza/periodicity/blob/master/visualizations/24hourmod_calendar_neighbors1.png)
...
![Example4](https://github.com/stevensouza/periodicity/blob/master/visualizations/0.png)

java -classpath .  com.stevesouza.surpriseimages.Paints 1
![Example5](https://github.com/stevensouza/periodicity/blob/master/visualizations/1.png)
